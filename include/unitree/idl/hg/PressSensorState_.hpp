...
template<> constexpr const char * TopicTraits<::unitree_hg::msg::dds_::PressSensorState_>::
getTypeName()
{
...
template<> constexpr unsigned int TopicTraits<::unitree_hg::msg::dds_::PressSensorState_>::
type_map_blob_sz() {return 406;}
template<> constexpr unsigned int TopicTraits<::unitree_hg::msg::dds_::PressSensorState_>::
type_info_blob_sz() {return 100;}
template<> inline const uint8_t * TopicTraits<::unitree_hg::msg::dds_::PressSensorState_>::
type_map_blob()
{
...
struct topic_type_name<::unitree_hg::msg::dds_::PressSensorState_>
{
  ...
  {
    return org::eclipse::cyclonedds::topic::TopicTraits<::unitree_hg::msg::dds_::PressSensorState_>
           ::getTypeName();
  }
};
...
bool write(
  T & streamer, const ::unitree_hg::msg::dds_::PressSensorState_ & instance,
...
template<typename T, std::enable_if_t<std::is_base_of<cdr_stream, T>::value, bool> = true>
bool read(
  T & streamer, ::unitree_hg::msg::dds_::PressSensorState_ & instance,
  entity_properties_t * props)
{
  (void)instance;
  if (!streamer.start_struct(*props)) {
